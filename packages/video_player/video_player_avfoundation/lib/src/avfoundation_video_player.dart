...
class AVFoundationVideoPlayer extends VideoPlayerPlatform {
  ...
  Future<void> startPictureInPicture(int textureId) {
    return _playerWith(id: textureId).startPictureInPicture(
      StartPictureInPictureMessage(textureId: textureId),
    );
  }

  @override
  Future<void> stopPictureInPicture(int textureId) {
    return _playerWith(id: textureId).stopPictureInPicture(
      StopPictureInPictureMessage(textureId: textureId),
    );
  }
